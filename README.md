# Front App Online Provider for OAuth 2.0 Client
...
```
composer require sumaerjolly/oauth2-frontapp
```

### Usage

Usage is the same as The League's OAuth client, using `\SumaerJolly\OAuth2\Client\Provider\FrontApp` as the provider.

### Authorization Code Flow

```php
$provider = new Sumaerjolly\OAuth2\Client\Provider\FrontApp([
